...
using Brains.Core.NeuralNetworks;
...
using Brains.Infrastructure.Layers;
...
namespace Brains.Infrastructure.NeuralNetworks
{
    public class NeuralNetwork : INeuralNetwork
    {
        public IInputLayer InputLayer { get; set; }
        public IList<ILayer> Layers { get; set; } = new List<ILayer>();
        public IOutputLayer OutputLayer => Layers.Last() as OutputLayer;
        ...
        {
            var layer = new HiddenLayer(numberOfNeurons, activationFunction, inputFunction);
            AddLayer(layer);
        }
        ...
        public void PushInputValues(double[] inputs)
        {
            ...
            {
                ((InputNeuron)InputLayer.Neurons[i]).PushValueOnOutput(inputs[i]);
            }
        }
